...
<nav class="navbar navbar-expand-lg navbar-light bg-light fixed-top"style="font-weight:bold;font-size:20px; color: white;
...
<!--slider ends-->
 ...
 <br><br><br><br>
<div>
	<img style="background-size:cover; width:100%;height:65%;" src="img\bgimg.jpeg" alt="">
		

<!--container 1 starts-->
<br><br>

<h2 style="color:green; margin-left:300px;font-weight:bold;font-size:70px;">Welcome to Food Hunt</h2>
<h3 style="color:green; margin-left:470px; font-weight:bold;font-size:40px;"> Happy To Serve You!!!</h3>
<br><br>
<br><br>
